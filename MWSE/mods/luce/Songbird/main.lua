...
--         local sideBlock = favList:createSideBySideBlock({ id = "sideBlock" })
...
--     --     postCreate = function(self)
--     --         mwse.log(json.encode(self.elements))
--     --         mwse.log(json.encode(self.parentComponent))
--     --     end })
...
--     local favouritesPage = template:createSideBarPage({ id = "favourites", label = "Favourites" })
--     constructFavouritesPage(favouritesPage)
--     local favList = favouritesPage:createCategory({ 
--             postCreate = function(self)
--                 mwse.log(json.encode(self.elements))
--                 mwse.log(json.encode(self.elements.outerContainer))
